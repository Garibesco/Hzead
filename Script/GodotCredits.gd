...
var credits = [
	[
		...
		"Music",
		"Gar Ib Aldifra (Ncesco)"
	],[
		"Sound Effects",
		"Programmer's voice & guitar"
	],[
		"Testers",
		"Fra",
		"Ncesco",
		...
		"",
		"WC Speed BTA",
		"http://www.wcfonts.com",
		"",
		"Gontserrat",
		"https://gabeclasson.com/projects/gontserrat/",
		"",
		
	],[
		"Graphic / Assets",
		"",
		"Free Dark Crystal Shrine",
		"https://frakassets.itch.io/free-dark-crystal-shrine",
		"",
		"Wasteland City – Parallax Background",
		"https://owmyknees.itch.io/wasteland-city-parallax-background",
		"",
		"Sacred Lands – Parallax Background",
		"https://owmyknees.itch.io/sacred-lands-parallax-background",
		"",
		"Gamepad UI / Controller Prompts Pack",
		"https://greatdocbrown.itch.io/gamepad-ui",
		"",
		"GamePad Guide Template",
		"https://rabbitteaparty.itch.io/gamepad-guide-template",
		"",
		"Godot Asset #2411",
		...
		"THANK YOU",
		"Hope you had a little fun playing",
		"this mess of a videogame",
		"<3",
		"",
		"",
		"",
